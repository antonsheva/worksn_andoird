...
public class SubMenu {
    ...
    public void show(Activity activity, Object targetObject, int targetObjectType, int left, int top){
        ...
        LinearLayout btRmv      = (LinearLayout)activity.findViewById(R.id.btRmv);
        LinearLayout btCopy     = (LinearLayout)activity.findViewById(R.id.btCopy);
        LinearLayout btReply    = (LinearLayout)activity.findViewById(R.id.btReply);
        LinearLayout btRecovery = (LinearLayout)activity.findViewById(R.id.btRecovery);
        LinearLayout btHidden   = (LinearLayout)activity.findViewById(R.id.btHidden);
        LinearLayout btShow     = (LinearLayout)activity.findViewById(R.id.btShow);
        LinearLayout btEdit     = (LinearLayout)activity.findViewById(R.id.btEdit);
        ...
        btRmv.setOnClickListener(new View.OnClickListener() {
            @Override
        ...
        btCopy.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                try{
                    ...
                    PUWindow.i().show("Текст скопирован в буфер обмена");
                }catch (Exception e){
                    e.printStackTrace();
                }
                hide(activity);
...
//    }
//
//    public void setTargetObjectType(int code) {
//        this.targetObjectType = code;
//    }
